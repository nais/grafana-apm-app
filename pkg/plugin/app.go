...
func (a *App) registerRoutes(mux *http.ServeMux) {
	...
	mux.HandleFunc("/services/{namespace}/{service}/triage", a.handleTriageStates)
	mux.HandleFunc("/services/{namespace}/{service}/triage/{fingerprint}", a.handleTriageAction)
	mux.HandleFunc("/services/{namespace}/{service}/triage/{fingerprint}/history", a.handleTriageHistory)
	...
	mux.HandleFunc("/alert-templates/{kind}", a.handleAlertTemplate)
